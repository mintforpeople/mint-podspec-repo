...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/mintforpeople/robobo-rob-interface-module-pod'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'lbajo' => 'lbajo9@gmail.com' }
  s.source           = { :git => 'https://github.com/mintforpeople/robobo-rob-interface-module-pod.git', :tag => s.version.to_s }
